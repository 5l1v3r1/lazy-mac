...
sim⇝ : ∀ {l π₁ π₂ τ τ₁ τ₂} {Δ₁ Δ₁' : Env l π₁} {Δ₂'  : Env l π₂} {t₁ t₁' : Term π₁ τ₁} {t₂' : Term π₂ τ₂}
         {S₁ S₁' : Stack l _ τ} {S₂' : Stack l _ τ} -> (l⊑A : l ⊑ A) ->
          Eraseᴱ Δ₁ Δ₁' -> Erase t₁ t₁' -> Eraseˢ S₁ S₁' -> ⟨ Δ₁' , t₁' , S₁' ⟩ ⇝ ⟨ Δ₂' , t₂' , S₂' ⟩
         -> Redexᴱ (yes l⊑A) ⟨ Δ₁ , t₁ , S₁ ⟩ ⟨ Δ₂' , t₂' , S₂' ⟩
