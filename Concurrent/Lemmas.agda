...
εᴳ-simᴴ H⋤A (CS.step-∅ l∈P t∈T ¬fork step sch uᵀ uᴾ) = lift-εᴳ (⌞ εˢ-simᴴ H⋤A sch ⌟) (stepᴴ-Γ H⋤A step) (updateᴾ∙ H⋤A uᴾ)
εᴳ-simᴴ H⋤A (CS.fork {l⊑H = L⊑H} l∈P t∈T step uᵀ u₁ᴾ H∈P₂ sch u₂ᴾ)
  = lift-εᴳ (⌞ εˢ-simᴴ H⋤A sch ⌟) (stepᴴ-Γ H⋤A step) (trans (updateᴾ∙ H⋤A u₁ᴾ) (updateᴾ∙ (trans-⋢ L⊑H H⋤A) u₂ᴾ))
εᴳ-simᴴ H⋤A (CS.fork∙ l∈P t∈T step uᵀ u₁ᴾ sch) = lift-εᴳ (⌞ εˢ-simᴴ H⋤A sch ⌟) (stepᴴ-Γ H⋤A step) (updateᴾ∙ H⋤A u₁ᴾ)
εᴳ-simᴴ H⋤A (CS.skip l∈P t∈T stuck sch) = lift-εᴳ (⌞ εˢ-simᴴ H⋤A sch ⌟) refl refl
εᴳ-simᴴ H⋤A (CS.done l∈P t∈T don sch) = lift-εᴳ (⌞ εˢ-simᴴ H⋤A sch ⌟) refl refl
